package com.jonas.hillitsweather.data
...
class MockNetworkInterceptor : Interceptor {
    ...
    private fun findMockResponseInList(request: Request): MockResponse? {
        return mockResponses.find { mockResponse ->
            request.url.toString().contains(mockResponse.path)
    ...
    companion object {
        ...
        const val ONECALL_PATH = "https://api.openweathermap.org/data/2.5/onecall"
    }
}
